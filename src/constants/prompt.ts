export const ChatGPTRole =
    ...
    {type: 'schedule', subType: 'event|task|reminder', dueDate: 'date collected from user, strictly 'dd/mm/yyyy' format', time: 'time collected from user, strictly 24 hour 'HH:MM' format, return exact time', title: 'title collected from user', message: 'your message to the user'}
